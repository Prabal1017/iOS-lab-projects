...
class Fighter: Spaceship {
    ...
    func fire()
    {
        if remainingFirePower>0
        {
            ...
            print("Remaining Fire Power : \(remainingFirePower)");
        }
        else
        {
...
//print(falconObject.weapon);
print("Error will come firstly because falconObject object isn't declared here. Next weapon is not a property of neither Spaceship class nor Fighter class, so falconObject cannot access weapon instance using dot operator.")
